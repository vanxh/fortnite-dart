...
class Avatar {
  ...
  Map<String, String> get avatarUrls => {
        "smallicon":
            "https://fortnite-api.com/images/cosmetics/br/${avatarId.split(":")[1].toLowerCase()}/smallicon.png",
        "icon":
            "https://fortnite-api.com/images/cosmetics/br/${avatarId.split(":")[1].toLowerCase()}/icon.png"
      };
